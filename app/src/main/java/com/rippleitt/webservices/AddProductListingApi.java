...
public class AddProductListingApi extends AsyncTask<String, Void, String> {
   ...
   // private final ProgressDialog dialog;
    ...
    public AddProductListingApi(Context mContext, String mproductName, String mproductPrice, String mproductDescription, String mWeight, String mUnit, String mcategory, String latitude, String longitude, String address, ArrayList arryImages) {
    ...
    protected void onPreExecute() {
       ...
       /* dialog = new ProgressDialog(c);*/
        try {
            connectURL = new URL(RippleittAppInstance.BASE_URL+RippleittAppInstance.ADD_NEW_PRODUCT);
        } catch (Exception ex) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            dos.writeBytes("Content-Disposition: form-data; name=\"1\"" + lineEnd);
            dos.writeBytes("Content-Type: text/plain;charset=UTF-8" + lineEnd);
            dos.writeBytes(lineEnd);
