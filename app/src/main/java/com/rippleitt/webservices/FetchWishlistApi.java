...
import com.rippleitt.adapters.WishlistAdapterView;
 ...
 */
public class FetchWishlistApi
{
    public void fetchWishlistApi(final Context context, final String page, final WishlistSelectCallback callback)
    {
        ...
        final StringRequest myRqst = new StringRequest(Request.Method.POST,
                RippleittAppInstance.BASE_URL +RippleittAppInstance.FETCH_WISHLIST_DETAILS, new Response.Listener<String>() {
            @Override
                  ...
                  //  maviLoaderHome.hide();
                    ...
                    if (status.equalsIgnoreCase("1")) {
                        ...
                        for (int i=0;i<data_array.length();i++){
                            ...
                            hashData.put("refer_amount",obj_data.getString("refer_amount"));
                            ...
                            hashData.put("wishlist_status",obj_data.getString("isaddedtowishlist"));
                            hashData.put("listing_type",obj_data.getString("listing_type"));
                            if (!obj_data.isNull("is_new"))
                            hashData.put("is_new",obj_data.getString("is_new"));
                            ...
                            Log.e("ARRAYLIST_IMAGES",arrayList+"");
                        ...
                        if(arry_Details==null || arry_Details.size()==0){
                           TextView mTxtViewNoEntries=(TextView)((Activity)context).findViewById(R.id.txtvwNoEntires);
                           mTxtViewNoEntries.setVisibility(View.VISIBLE);
                            //Toast.makeText(context,"You have not added any listings in your wishlist",Toast.LENGTH_LONG).show();
                        }
                        RecyclerView recyclerView = (RecyclerView)((Activity)context).findViewById(R.id.recyclerViewWishList);
                        AVLoadingIndicatorView    maviLoaderHomeCenter=(AVLoadingIndicatorView)((Activity)context).findViewById(R.id.aviLoaderHomeCenter);
                        maviLoaderHomeCenter.setVisibility(View.GONE);
                        StaggeredGridLayoutManager staggeredGridLayoutManager = new StaggeredGridLayoutManager(2, LinearLayoutManager.VERTICAL);
                        recyclerView.setLayoutManager(staggeredGridLayoutManager);
                        WishlistAdapterView wishlistAdapterView = new WishlistAdapterView(context, arry_Details,callback);
                        recyclerView.setAdapter(wishlistAdapterView);
                    }
                    else {
        ...
        })
        {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                Log.e("Fetch_Wishlist_Params",params+"");
                return params;
            }
        };
